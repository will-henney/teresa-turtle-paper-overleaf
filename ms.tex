...
and is more than an order of magnitude denser than the lobes,
which accounts for the low ionization of the knots.
...
In terms of the GISW model, the halo represents the fossil AGB wind.
...
Since the propagation of the ionization front through the halo is always R-type \citep{Kahn:1954a},
the gas experiences no mechanical effect and maintains its original density and velocity profile.
