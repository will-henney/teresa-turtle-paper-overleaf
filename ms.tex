...
\begin{table*}
  ...
  \begin{tabular}{
    ...
    {Component} & {\% of total}& {\si{H.cm^{-3}}} & {\(M_\odot\)} & {\num{1e-4}}         & {\SI{1000}{yr}}      & {\SI{1000}{yr}}    & {\si{\msun.yr^{-1}}} & {\si{km.s^{-1}}}\\
    \midrule
    {(1)} & {(2)} & {(3)} & {(4)} & {(5)} & {(6)} & {(7)} & {(8)} & {(9)}\\
    \addlinespace
    Inner shells & 44\% & 4000--5000 & 0.078 & 36--70 & -4 & -1.5 & 3.1e-5 & 40--55\\
    Intermediate shell & 13\% & 700--1000 & 0.135 & 80--140 & -10 & -4 & 2.3e-5& 35--38\\
    Knot complexes & 42\% & 2000--5000 & 0.063 & 4--50 & -8 & -1.5 & 9.7e-6& 24--67\\
    Outer Lobes & 1\% & 160--320 & 0.024 & 86--224 & -5 & -2 & 8e-6 & 40--90\\
    Inner Halo & 0.5\% & 80--160 & 0.030 & 200--340 & -20 & -10 & 3e-6 & 15: \\
    Outer Halo & 0.2\% & 15--40 & 0.042 & 540--760 & -40 & -20 & 2.1e-6 & 7: \\
    \addlinespace
    NW knot & 0.01\% & 6700 & 1e-5 & 6 & -7.1 & -6.7 & 2.5e-8 & 24\\
    SE knot & 0.08\% & 8200 & 6e-5 & 34 & -1.25 & -0.95 & 2e-7 & 54\\
    N knot &  0.02\% & 3000 & 3e-5 & 12 & -3.0 & -2.7 & 1e-7 & 67\\
    \bottomrule
  \end{tabular}
\end{table*}
...
In the case of shells, the start time is taken as the kinematic time of material just outside the shell (for instance, the innermost halo material in the case of the intermediate shell).
...
In general, the mass loss is seen to increase monotonically over the last \SI{40,000}{yr} from about \SI{2e-6}{\msun.yr^{-1}} to about \SI{3e-5}{\msun.yr^{-1}} in the last few thousand years.
...
The mass-loss rate is expected to have declined significantly since then, with a present-day value of \(\dot{M} = \SI{9.12e-9}{M_\odot.yr^{-1}}\) at a wind velocity of \(V = \SI{2150}{km.s^{-1}}\) \citep{Herald:2011a}.
