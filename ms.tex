...
\begin{abstract}
  ...
  of the spectacularly asymmetrical planetary nebula:
  NGC~6210, known as the Turtle Nebula.
  We study the three-dimensional structure and kinematics of the nebula's shells, lobes, knots, and haloes
  ...
  We find that the nebula has five separate ejection axes, which we label A~to~E.\@
  Axes~A and B are major axes of the bipolar wind-blown inner shell
  and the lop-sided, elliptical, fainter, but more massive intermediate shell, respectively.
  Axes~C and D (and also A) are bipolar flow axes that form the point symmetric,
  high-ionization outer lobes, all with inclinations close to the plane of the sky.
  Axis~E, which is inclined close to the line of sight,
  is the axis of a loosely collimated outflow of low-ionization knots.
...
e Inovación Tecnológica  IN107019 and \textbf{Ensenada grant?}.  
