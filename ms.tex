...
In this section we list the principle ways in which the nebula is lop-sided:
\begin{enumerate}[1.]
...
The descendant system should be a binary or a triple,
depending on whether a merger occurred,
but there is no direct evidence that the Turtle's central star is a binary.
...
suggests that a triple interaction was not involved in the initial ejection of the envelope that forms the intermediate shell,
although it may be responsible for its shaping.
The existence of two such different 
