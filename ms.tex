...
\begin{table*}
  ...
  \begin{tabular}{
    ...
    SE knot & 135 & \AxM{E}(i) & -35 \pm 3 & 39 \pm 10 & 57 \pm 7 & -47 \pm 8 & 6 \pm 1 & 0.09 \pm 0.02 & 1.5 \pm 0.4\\
    \bottomrule
...
which significantly differ by more than \(3\sigma\).
...
We therefore consider a worst-case scenario in which a shift of this magnitude
is applied along \(\text{PA} = \ang{315}\),
which is the average projected axis of the knot outflow.
Repeating all the proper motion measurements for this then yields
\(t_{\text{kin}}(\AxP{E}) = \SI{3.7 \pm 0.5}{kyr}\) 
versus \(t_{\text{kin}}(\AxM{E}) = \SI{2.3 \pm 0.3}{kyr}\).
The difference between the timescales of the positive and negative axes is smaller in this scenario, \(\SI{1.4 \pm 0.6}{kyr}\),
