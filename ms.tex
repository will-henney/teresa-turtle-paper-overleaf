...
A large fraction of planetary nebulae show deviations from axisymmetry \citep{Soker:2001a}.
...
which is the opposite to the trend that is typically seen in multiple-shell planetary nebulae \citep{Corradi:2007a}.  In a sample of 20 high-luminosity nebulae, \citet{Schonberner:2014a} find that the intermediate shell expansion velocity lies in the range \num{20} 
...
Inner shell is ``core'' in Balick, ``rim'' 
