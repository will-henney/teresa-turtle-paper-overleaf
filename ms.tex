...
\subsection{Density and ionization structure of the nebula}
\label{sec:ionization-structure}
...
\begin{table*}
  ...
  \begin{tabular}{
    ...
    \toprule
    {}          & {\Ha{} flux} & {Ionized Density} & {Ionized Mass}    & {Ionization Parameter} & {\(t_{\text{start}}\)} & {\(t_{\text{end}}\)} & {\(\dot{M}\)}\\
    {Component} & {\% of total}& {\si{H.cm^{-3}}} & {\(M_\odot\)} & {\num{1e-4}}         & {\SI{1000}{yr}}      & {\SI{1000}{yr}}    & {\si{\msun.yr^{-1}}}\\
    \midrule
    {(1)} & {(2)} & {(3)} & {(4)} & {(5)} & {(6)} & {(7)} & {(8)} \\
    \addlinespace
    Inner shells & 44\% & 4000--5000 & 0.078 & 36--70 & -4 & -1.5 & 3.1e-5\\
    Intermediate shell & 13\% & 700--1000 & 0.135 & 80--140 & -10 & -4 & 2.3e-5\\
    Knot complexes & 42\% & 2000--5000 & 0.063 & 4--50 & -8 & -1.5 & 9.7e-6\\
    Outer Lobes & 1\% & 160--320 & 0.024 & 86--224 & -8 & -2 & 4e-6\\
    Inner Halo & 0.5\% & 80--160 & 0.030 & 200--340 & -20 & -10 & 3e-6\\
    Outer Halo & 0.2\% & 15--40 & 0.042 & 540--760 & -40 & -20 & 2.1e-6\\
    \addlinespace
