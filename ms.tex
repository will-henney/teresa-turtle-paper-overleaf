...
The inner shell probably represents material that has been shock-compressed by the expansion of the fast stellar wind from the central star.
...
with an opposite sense in \heii{} from that in \ha{} and \oiii{}. 
The expansion velocity of the intermediate shell is \SI{35}{km.s^{-1}},
while the inner shell expands faster at \SI{50}{km.s^{-1}},
which is atypical of double-shell planetary nebulae.
