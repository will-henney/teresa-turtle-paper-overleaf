...
%DIF DEL ms-v1-expand.tex   Mon Dec  7 12:23:19 2020
%DIF ADD ms-v2-expand.tex   Mon Dec  7 12:23:59 2020
%DIF 2-12c2
%DIF < \pdfsuppresswarningpagegroup=1
%DIF < %
%DIF < \usepackage[spanish,es-minimal,english]{babel}
...
%DIF < \usepackage[stix2,smallerops]{newtxmath}
%DIF -------
\usepackage{wjh-packages} %DIF > 
%DIF -------
\usepackage{booktabs}
...
\begin{abstract}
  ...
  We detect major changes in outflow directions \DIFdelbegin \DIFdel{over the last 6000~years,
  beginning in the pre-planetary nebula phaseand continuing through the }\DIFdelend \DIFaddbegin \DIFadd{during the planetary nebula phase, 
  starting at or before the initial }\DIFaddend ionization of the nebula \DIFdelbegin \DIFdel{, which began }\DIFdelend 3500~years ago.
  Most notably,
  \DIFdelbegin \DIFdel{all }\DIFdelend \DIFaddbegin \DIFadd{the majority of }\DIFaddend redshifted low-ionization knots have kinematic ages greater than 2000~years,
  whereas \DIFdelbegin \DIFdel{all }\DIFdelend \DIFaddbegin \DIFadd{the majority of }\DIFaddend blueshifted knots have ages younger than 2000~years. 
...
\DIFdelbegin \DIFdel{More recent images,
}\DIFdelend \DIFaddbegin \DIFadd{To the best of our knowledge,
the first use of the name Turtle with regard to NGC~6210
was in a 1998 NASA press release%DIF > 
}\footnote{\url{https://hubblesite.org/contents/news-releases/1998/news-1998-36.html}}
\DIFadd{that described images of the nebula }\DIFaddend obtained with the
\textit{Hubble Space Telescope} (\textit{HST})\DIFaddbegin \DIFadd{.
Those and more recent }\textit{\DIFadd{HST}} \DIFadd{images}\DIFaddend %
\footnote{
...
% full_filename figs/turtle-overview
% after 
...
% before    
% ignored  
% args width=0.38\textwidth
%DIF <  full_filename tere-figs/Figure2a
%DIF >  full_filename figs/turtle-slits
% after 
   \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.38\textwidth]{tere-figs/Figure2a}
%DIFDELCMD <    %%%
...
% before   
% ignored  
% args width=0.95\textwidth
% full_filename tere-figs/Figure3
% after 
...
% ignored  
% args width=\linewidth
%DIF >  full_filename figs/turtle-1d-line-profiles
%DIF >  after 
  \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/turtle-1d-line-profiles}
  \caption{
    \DIFaddFL{Thick colored lines show one-dimensional extracted velocity profiles
    of (top to bottom) }\nii{} \DIFaddFL{(red), }\Ha{} \DIFaddFL{(purple) and }\oiii{} \DIFaddFL{(light blue)
    for a  short section of slit~e
    (length \mbox{%DIFAUXCMD
\SI{2}{arcsec}}\hspace{0pt}%DIFAUXCMD
,
    centered \mbox{%DIFAUXCMD
\SI{3}{arcsec} }\hspace{0pt}%DIFAUXCMD
north of the central star).
    For the }\nii{} \DIFaddFL{and }\oiii{} \DIFaddFL{lines, four-gaussian fits are shown
    ...
    No fits are performed to the }\Ha{} \DIFaddFL{line
...
\DIFaddendFL % full_filename figs/turtle-halo-slit-x
% after 
  ...
  \caption{
    ...
    The position of slit\DIFdelbeginFL \DIFdelFL{position X }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{~x }\DIFaddendFL is shown, for which a deep \Ha{} spectrum was obtained.
    ...
    (b)~\Ha{} spectrum from \DIFdelbeginFL \DIFdelFL{Slit}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{slit}\DIFaddendFL ~\DIFdelbeginFL \DIFdelFL{X}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{x}\DIFaddendFL , showing emission from two of the halo knots.
...
\DIFaddbegin \DIFadd{Figure~\ref{fig:spec-1d} shows example one-dimensional spectra,
extracted from a short section of slit~e.
}\DIFaddend % We derive a heliocentric
...
An additional slit (\DIFdelbegin \DIFdel{X}\DIFdelend \DIFaddbegin \DIFadd{x}\DIFaddend , shown in Figure~\ref{fig:halo-knots}) was placed on the northern outskirts of the nebula 
...
% ignored  
% args width=\linewidth
% full_filename figs/oiii-propermotions-lores
% after 
...
% ignored  
% args width=\linewidth
% full_filename figs/nii-propermotions-lores
% after 
...
\begin{figure*}
  \centering
  %DIF >  \includegraphics[width=\linewidth]{figs/turtle-peanut-map-lores}
% inside_import 
% before   
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/turtle-peanut-map-lores
%DIF >  full_filename figs/turtle-peanut-map
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/turtle-peanut-map-lores}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/turtle-peanut-map}
  \DIFaddendFL \caption{
    Velocity features in the high-ionization shells,
    which have been identified in the \oiii{} slits.
    \DIFdelbeginFL \DIFdelFL{Left panel shows blue-shifted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(a)~Blue-shifted }\DIFaddendFL features\DIFdelbeginFL \DIFdelFL{,
    while right panel shows red-shifted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. 
    (b)~Red-shifted }\DIFaddendFL features\DIFdelbeginFL \DIFdelFL{,
    each }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{.
    Each are }\DIFaddendFL labelled with their line-of-sight velocity
    ...
    \DIFaddbeginFL \DIFaddFL{The star symbol in this and subsequent figures indicates the position of the central star.
  }\DIFaddendFL }
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-heii-shell-components
% after 
  ...
  \caption{
    ...
    \DIFdelbeginFL \DIFdelFL{Left panel shows blue-shifted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(a)~Blue-shifted }\DIFaddendFL features\DIFdelbeginFL \DIFdelFL{,
    while right panel shows red-shifted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. (b)~Red-shifted }\DIFaddendFL features\DIFdelbeginFL \DIFdelFL{,
    each }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{.
    Each are }\DIFaddendFL labelled with their line-of-sight velocity
    with respect to the nominal systemic velocity of \SI{-40}{km.s^{-1}}.
    The line width is a qualitative indicator of the brightness of each feature,
...
\begin{figure*}
  \centering
  %DIF >  \includegraphics[width=\linewidth]{figs/turtle-knot-complex-map-lores}
% inside_import 
% before   
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/turtle-knot-complex-map-lores
%DIF >  full_filename figs/turtle-knot-complex-map
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/turtle-knot-complex-map-lores}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/turtle-knot-complex-map}
  \DIFaddendFL \caption{
    ...
    (b)~Red-shifted }\DIFaddendFL features\DIFdelbeginFL \DIFdelFL{,
    each }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{.
    Each is }\DIFaddendFL labelled with their line-of-sight velocity
    with respect to the nominal systemic velocity of \SI{-40}{km.s^{-1}}.
    The line width is a qualitative indicator of the brightness of each feature.
  }
...
%DIFDELCMD <   {figs/turtle-lobes-simplified-components-lores}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]
  {figs/turtle-lobes-simplified-components}
  %DIF >  {figs/turtle-lobes-simplified-components-lores}
  \DIFaddendFL \caption{
...
\begin{figure}
  \centering
  %DIF >  \includegraphics[width=\linewidth]{figs/turtle-halo-map-lores}
% inside_import 
% before   
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/turtle-halo-map-lores
%DIF >  full_filename figs/turtle-halo-map
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/turtle-halo-map-lores}
%DIFDELCMD <   %%%
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-shell-velocity-axes-annotated
% after 
...
\DIFaddbegin \DIFadd{Original images had the source centered on the
WFPC2 camera's WFC3 chip (first epoch)
or PC chip (second epoch). 
}\DIFaddend Images were aligned \DIFdelbegin \DIFdel{with }\DIFdelend \DIFaddbegin \DIFadd{to the celestial coordinate frame using }\DIFaddend Astrodrizzle%
\footnote{\url{https://drizzlepac.readthedocs.io}}\DIFdelbegin \DIFdel{and proper motions were }\DIFdelend \DIFaddbegin \DIFadd{,
...
at the WFC resolution of \mbox{%DIFAUXCMD
\SI{0.1}{arcsec.pix^{-1}}}\hspace{0pt}%DIFAUXCMD
. 
Proper motions were then }\DIFaddend estimated from pairs of images
\DIFdelbegin \DIFdel{seperated }\DIFdelend \DIFaddbegin \DIFadd{separated }\DIFaddend by 10 to 12 years,
%DIF <  The data used in this study to measure the proper motions of the turttle nebula consist of images which were retrieved from the HST archive. The \nii{} observations were made in two separate observing runs: on 1998 June 30, as part of program 7501, with Hajian, Arsen R., as PI. During this run, six images were obtained with the WFPC2, with an exposure time of 100 s (three images) y 40 s (three images) using the F658N filter. The second-epoch data were obtained on 2008 January 18, from the science program 11122, with Bruce Balick, as PI, who employed the same configuration as in program 7501 to acquire three images with the F658N filter, using 400 s exposure times for all of them. For all of the images, we used the drizzled images (processed with Astrodrizzle). 
\DIFdelbegin \DIFdel{using the FLCT method \mbox{%DIFAUXCMD
\citep{Welsch:2004a, Fisher:2008a}}\hspace{0pt}%DIFAUXCMD
.}\DIFdelend \DIFaddbegin \DIFadd{using the Fourier Local Correlation Tracking (FLCT) method \mbox{%DIFAUXCMD
\citep{Welsch:2004a, Fisher:2008a}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend \footnote{
...
\DIFaddbegin \DIFadd{with a kernel width of 10~pixels.
}\DIFaddend Results are shown in Figures~\ref{fig:proper-motions-oiii} and~\ref{fig:proper-motions-nii} for \oiii{} (filter F502N) and \nii{} (filter F658N), respectively.
\DIFdelbegin \DIFdel{In both cases, the images were remapped to a uniform square pixel grid at the WFC resolution of \mbox{%DIFAUXCMD
\SI{0.1}{arcsec.pix^{-1}} }\hspace{0pt}%DIFAUXCMD
before applying the algorithm.
}\DIFdelend The resultant per-pixel motions between the two epochs are found to be of order \SI{0.5}{pix} (\(\approx \SI{5}{mas.yr^{-1}}\))
...
\DIFaddbegin \DIFadd{and residual uncertainties in the distortion correction
}\DIFaddend is estimated to be \SI{1.5}{mas.yr^{-1}},
...
\DIFaddbegin \DIFadd{Although some non-radial vectors are seen in the figure,
these tend to be in the faintest parts of the nebula
and are likely to be dominated by random noise.
}\DIFaddend From the \oiii{} images (Fig.~\ref{fig:proper-motions-oiii}),
...
\DIFaddbegin \DIFadd{The velocities were determined by fitting gaussians to one-dimensional line profiles,
as illustrated in Figure~\ref{fig:spec-1d}.
The higher ionization features are measured in }\oiii{}\DIFadd{,
while the lower ionization features are measured in }\nii{}\DIFadd{.
}

\DIFaddend Maps of the individual slit positions,
...
(\DIFdelbegin \DIFdel{left and right panels}\DIFdelend \DIFaddbegin \DIFadd{panels~a and~b}\DIFaddend , respectively).
...
and velocities close to zero at either end\DIFdelbegin \DIFdel{(\(\pm 7''\))}\DIFdelend .
The pattern is not entirely symmetric,
\DIFdelbegin \DIFdel{with }\DIFdelend \DIFaddbegin \DIFadd{showing }\DIFaddend a slight gradient  of \(\pm \SI{3}{km.s^{-1}}\)
\DIFaddbegin \DIFadd{over \(\pm 7''\) }\DIFaddend along the length \DIFaddbegin \DIFadd{of the axis}\DIFaddend ,
...
the ellipse is distorted and the \DIFdelbegin \DIFdel{gradient }\DIFdelend \DIFaddbegin \DIFadd{velocity differential }\DIFaddend is much more pronounced:
\(\pm \SI{11}{km.s^{-1}}\),
...
However, one of the \nii{} slits (slit~\DIFdelbegin \DIFdel{W}\DIFdelend \DIFaddbegin \DIFadd{w}\DIFaddend ) is indeed oriented close to axis~B and,
...
However, the evidence from \textit{HST} imaging suggests that the shell \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{may be }\DIFaddend closed in this direction also \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{(indicated by thin dashed blue line in the lower panel of Fig.~\ref{fig:shell-velocity-axes}).
}\DIFaddend 
...
The gradient (\(\pm \SI{9}{km.s^{-1}}\) \DIFaddbegin \DIFadd{over \(\pm 11''\)}\DIFaddend )
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-heii-shell-annotated
% after 
  ...
  \caption{
    ...
    \DIFdelbeginFL \DIFdelFL{The star symbol indicates the position of the central star.
    }\DIFdelendFL No spatial interpolation is performed, so regions between the slits are lacking data,
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-heii-shell-velocity-axes-annotated
% after 
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-nii-knot-complexes
% after 
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-knot-complexes-velocity-axes-annotated
% after 
...
it is apparent that there is a significant gradient of \(\approx \SI{20}{km.s^{-1}}\) \DIFaddbegin \DIFadd{over \(\pm 8''\)
}\DIFaddend along axis~B, which is seen in both blue-shifted and red-shifted components.
...
show significant internal gradients of \(\approx \SI{10}{km.s^{-1}}\) \DIFaddbegin \DIFadd{over \(10''\) }\DIFaddend in the same direction.
...
which show that the \oiii{} emission associated with the complexes \DIFdelbegin \DIFdel{is more diffuse than the compact }\DIFdelend \DIFaddbegin \DIFadd{seems to arise from the inner surface of the}\DIFaddend \nii{} knots.
...
%DIFDELCMD <     {(1)} %%%
\DIFdelendFL \DIFaddbeginFL \addlinespace[1pt]
    {(1)} \DIFaddendFL & {(2)} & {(3)} & {(4)} & {(5)} & {(6)} & {(7)} & {(8)} & {(9)} & {(10)} \\
    \DIFdelbeginFL %DIFDELCMD < \addlinespace
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \midrule
    \DIFaddendFL Inner shell A NNW & 340 & \AxP{A} & +8 \pm 3 & 48 \pm 7 & 49 \pm 7 & 11 \pm 4 & 7 \pm 1 & 0.07 \pm 0.01 & 1.4 \pm 0.2\\
    ...
    NE Blue complex & 60 & \AxM{E}(iii) & -51 \pm 1 & \DIFdelbeginFL \DIFdelFL{23 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{24 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{65 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{66 }\DIFaddendFL \pm 2 & -69 \pm \DIFdelbeginFL \DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2 }\DIFaddendFL & 5 \pm 1 & 0.14 \pm \DIFdelbeginFL \DIFdelFL{0.04 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.01 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{2.1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.0 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.6}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.2}\DIFaddendFL \\
    ...
    SW Red complex & 250 & \AxP{E}(iii) & +38 \pm 1 & \DIFdelbeginFL \DIFdelFL{18 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{17 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4 }\DIFaddendFL & 49 \pm 2 & \DIFdelbeginFL \DIFdelFL{68 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{70 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4 }\DIFaddendFL & 7 \pm 2 & \DIFdelbeginFL \DIFdelFL{0.19 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.20 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.06 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.04 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{3.7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.9 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{1.2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.9}\DIFaddendFL \\
    NE Red complex & 30 & \AxP{E}(ii) & +25 \pm 2 & \DIFdelbeginFL \DIFdelFL{5 }%DIFDELCMD < \pm %%%
\DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{<8 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{30 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{31 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{2 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{81 }%DIFDELCMD < \pm %%%
\DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{> 75 }\DIFaddendFL & 4 \pm 1 & \DIFdelbeginFL \DIFdelFL{0.26 }%DIFDELCMD < \pm %%%
\DIFdelFL{0.21 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{> 0.15  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{8.0 }%DIFDELCMD < \pm %%%
\DIFdelFL{6.7}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{>5}\DIFaddendFL \\
    SW Faint Blue & 225 & \AxM{E}(ii) & -26 \pm 1 & \DIFdelbeginFL \DIFdelFL{26 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{17 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{41 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{36 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-50 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-61 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14 }\DIFaddendFL & 7 \pm 1 & \DIFdelbeginFL \DIFdelFL{0.11 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.14 }\DIFaddendFL \pm 0.02 & \DIFdelbeginFL \DIFdelFL{2.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.9 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.5}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.2}\DIFaddendFL \\
    \addlinespace
    ...
    NW knot  & 310 & \AxP{E}(i) & +18 \pm 1 & \DIFdelbeginFL \DIFdelFL{11 }%DIFDELCMD < \pm %%%
\DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{< 14 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{24 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{23 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{63 }%DIFDELCMD < \pm %%%
\DIFdelFL{17 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{>57 }\DIFaddendFL & 8 \pm 1 & \DIFdelbeginFL \DIFdelFL{0.18 }%DIFDELCMD < \pm %%%
\DIFdelFL{0.10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{> 0.15  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{6.7 }%DIFDELCMD < \pm %%%
\DIFdelFL{4.5}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{> 5}\DIFaddendFL \\
    NW Red complex & 300 & \AxP{E}(i) & +21 \pm 2 & \DIFdelbeginFL \DIFdelFL{10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7 }\DIFaddendFL \pm 4 & \DIFdelbeginFL \DIFdelFL{27 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{26 }\DIFaddendFL \pm 3 & \DIFdelbeginFL \DIFdelFL{68 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{74 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{9 }\DIFaddendFL & 6 \pm 2 & \DIFdelbeginFL \DIFdelFL{0.16 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.22 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.08 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.12 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{6.0 }%DIFDELCMD < \pm %%%
\DIFdelFL{3.1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{> 4}\DIFaddendFL \\
    Outer lobe \SysM{10} & 120 & \AxM{D} & -8 \pm 4 & 24 \pm 14 & 26 \pm 13 & -22 \pm 15 & 13 \pm 3 & 0.14 \pm 0.04 & 5.2 \pm 3.3\\
    SE Blue complex & 135 &  \AxM{E}(i) & -31 \pm 3 & \DIFdelbeginFL \DIFdelFL{39 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{32 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{11 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{54 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{49 }\DIFaddendFL \pm 8 & \DIFdelbeginFL \DIFdelFL{-44 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-49 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.07 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.05 }\DIFaddendFL \pm 0.02 & \DIFdelbeginFL \DIFdelFL{1.1 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.9 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.4}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.3}\DIFaddendFL \\
    SE knot & 135 & \AxM{E}(i) & -35 \pm 3 & \DIFdelbeginFL \DIFdelFL{39 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{42 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{57 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{59 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-47 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-45 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5 }\DIFaddendFL \pm 1 & \DIFdelbeginFL \DIFdelFL{0.09 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.07 }\DIFaddendFL \pm 0.02 & \DIFdelbeginFL \DIFdelFL{1.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.1 }\DIFaddendFL \pm \DIFdelbeginFL \DIFdelFL{0.4}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.1}\DIFaddendFL \\
    \bottomrule
...
% ignored  
% args width=\linewidth
% full_filename figs/turtle-inclination-histogram
% after 
...
\begin{figure}
  ...
  \caption{
    ...
    cross symbols are low-ionization knots or knot complexes (\S~\ref{sec:knot-complexes}\DIFaddbeginFL \DIFaddFL{, plus symbol for redshifted and times symbol for blueshifted}\DIFaddendFL ),
    diamond symbols are high-velocity and intermediate-velocity systems in the outer lobes (\S~\ref{sec:outer-lobes}).
    Error bars show the \DIFdelbeginFL \DIFdelFL{observational uncertainties given in }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{random errors on }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{table,
    except for outer lobe system }%DIFDELCMD < \SysM{2}%%%
\DIFdelFL{, where the lack of }\DIFdelendFL proper motion measurements\DIFdelbeginFL \DIFdelFL{mean that only }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{,
    with black arrows indicating }\DIFaddendFL lower limits\DIFaddbeginFL \DIFaddFL{.
    Fainter symbols show re-analysis of the knot systems under a
    worst-case scenario }\DIFaddendFL for \DIFdelbeginFL \DIFdelFL{\(V_{\text{tot}}\) and \(R\) are available}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{systematic errors in the proper motions}\DIFaddendFL ,
    \DIFdelbeginFL \DIFdelFL{indicated by arrows}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{which has opposite effects on the red and blue knots}\DIFaddendFL .
    ...
    Also shown (gray ellipses) are the expansion velocity and range of radii of the inner \DIFaddbeginFL \DIFaddFL{(dark) }\DIFaddendFL and outer \DIFaddbeginFL \DIFaddFL{(light) }\DIFaddendFL halo features (\S~\ref{sec:haloes}).
  }
  \label{fig:ages}
\end{figure}
...
\begin{figure}
  ...
  \caption{
    ...
    \DIFdelbeginFL \DIFdelFL{except }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{but are larger }\DIFaddendFL for \DIFdelbeginFL %DIFDELCMD < \AxP{E}%%%
\DIFdelendFL \DIFaddbeginFL \AxM{D} \DIFaddFL{and }\AxM{E}\DIFaddendFL (ii)\DIFdelbeginFL \DIFdelFL{where }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{.
    For Axis~E, semi-circular symbols indicate lower limits,
    while fainter symbols show }\DIFaddendFL the \DIFaddbeginFL \DIFaddFL{results of a re-analysis
    assuming a worst-case systematic }\DIFaddendFL uncertainty \DIFdelbeginFL \DIFdelFL{is much higher}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{in the proper motions}\DIFaddendFL .
  }
...
\DIFaddbegin \DIFadd{In the case of the halo, no line splitting is observed,
so we estimate the expansion velocity as \(V = 0.5 W\),
where \(W\) is the intrinsic FWHM of the line (section~\ref{sec:haloes}).
}\DIFaddend Diagonal lines show constant values of kinematic time (distance divided by velocity)
...
\DIFaddbegin \DIFadd{This dichotomy between the two arms of axis~E
...
greater than 50\% for the }\AxP{E} \DIFadd{axis and \(\approx 30\%\) for the }\AxM{E} \DIFadd{axis,
...
\mbox{%DIFAUXCMD
\SI{1.5}{arcsec.yr^{-1}} }\hspace{0pt}%DIFAUXCMD
or \mbox{%DIFAUXCMD
\SI{\pm 14}{km.s^{-1}}
}\hspace{0pt}%DIFAUXCMD
(see section~\ref{sec:proper-motions}).
We therefore consider a scenario in which a shift of this magnitude
is applied between the two epochs of }\textit{\DIFadd{HST}} \DIFadd{observations.
...
\DIFaddend \subsection{Density structure of the nebula}
...
%     Red knots & 11\% & 2000--5000 & 0.038 & 0.0004--0.0020 & \DIFdelbeginFL \DIFdelFL{-8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-5 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-3.7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-3 }\DIFaddendFL & 9.5e-6& 25-40\\
%     Blue knots & 4\% & 1500--2000 & 0.025 & 0.0040--0.0170 & \DIFdelbeginFL \DIFdelFL{-2.7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-3 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-1.2 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-1 }\DIFaddendFL & 1.2e-5& 40--65\\
...
%     \addlinespace
%     NW knot & 0.01\% & 6700 & 1e-5 & 0.0006 & \DIFdelbeginFL \DIFdelFL{-7.1 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{-6.7 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{2.5e-8 }\DIFdelendFL & 24\\
%     SE knot & 0.08\% & 8200 & 6e-5 & 0.0034 & \DIFdelbeginFL \DIFdelFL{-1.25 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{-0.95 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{2e-7 }\DIFdelendFL & 54\\
%     N knot &  0.02\% & 3000 & 3e-5 & 0.0012 & \DIFdelbeginFL \DIFdelFL{-3.0 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{-2.7 }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{1e-7 }\DIFdelendFL & 67\\
%     \bottomrule
%   \end{tabular}
\end{table*}
...
\begin{figure}
  ...
  \caption{
    ...
    The \DIFdelbeginFL \DIFdelFL{red vertical line shows the end of the }\DIFdelendFL period of high mass-loss \DIFaddbeginFL \DIFaddFL{ended approximately \mbox{%DIFAUXCMD
\SI{1500}{yr} }\hspace{0pt}%DIFAUXCMD
ago}\DIFaddendFL .
...
In all cases, it is implicitly assumed that no significant acceleration or deceleration has taken place \DIFdelbegin \DIFdel{,
which may not be accurate, especially for the inner shell that has been shocked due to the action of the fast wind}\DIFdelend \DIFaddbegin \DIFadd{since the material was ejected from the star.
If instead the material was initially ejected at a lower velocity and later accelerated to its currently observed velocity, then the ages would be underestimated}\DIFaddend .
...
\DIFaddbegin \DIFadd{in Figure~\ref{fig:mass-loss-history}}\DIFaddend .
...
% ignored  
% args width=\linewidth
% full_filename figs/hr-pne-annotated
% after 
...
there is evidence for a change in the outflow direction about \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\SI{3500}{yr} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{3000}{yr} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend ago,
but in the case of the knot complexes it is a much more dramatic shift of \ang{180},
from \DIFdelbegin \DIFdel{exclusively }\DIFdelend \DIFaddbegin \DIFadd{predominantly }\DIFaddend red-shifted ejections before that time to \DIFdelbegin \DIFdel{exclusively }\DIFdelend \DIFaddbegin \DIFadd{predominantly }\DIFaddend blue-shifted ejections afterward (see Figure~\ref{fig:axis-history}).
...
\item The inner shell emission in \oiii{} and \Ha{} shows brightness asymmetries in both position and velocity.
  ...
  redshifted emission is \DIFdelbegin \DIFdel{2.5 times brighter on the northside}\DIFdelend \DIFaddbegin \DIFadd{brighter to the north}\DIFaddend ,
  while blueshifted emission is \DIFdelbegin \DIFdel{1.5 times brighter on the southside}\DIFdelend \DIFaddbegin \DIFadd{brighter to the south}\DIFaddend .
  Because the inner shell dominates the total flux, this leads to a north--south asymmetry in the nebula as a whole,
  with the peak brightness region lying \DIFdelbegin \DIFdel{2~arcsec }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{2}{arcsec} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend north of the central star. 
\item In the \heii{} line, the inner shell has an opposite asymmetry: it is brighter to the south than to the north, as measured in our slit spectra.
  ...
  Note however that there is a gap in our slit coverage in precisely the region of maximum \Ha{} brightness, so it is possible that this discrepancy \DIFaddbegin \DIFadd{is }\DIFaddend only apparent.
...
\item \DIFdelbegin \DIFdel{A }\DIFdelend \DIFaddbegin \DIFadd{Either at the same time, or possibly a }\DIFaddend few thousand years \DIFdelbegin \DIFdel{after that}\DIFdelend \DIFaddbegin \DIFadd{later}\DIFaddend ,
...
% ignored  
% args width=\linewidth
% full_filename figs/cousins-of-the-turtle-lores
% after 
...
\DIFaddbegin \DIFadd{Our preferred systemic heliocentric velocity for NGC~6210 is \mbox{%DIFAUXCMD
\SI{-39.3}{km.s^{-1}}}\hspace{0pt}%DIFAUXCMD
,
based on the centroid velocity of the slowly expanding halo. 
}\DIFaddend 
...
\DIFdelbegin \DIFdel{from \num{8000} to \mbox{%DIFAUXCMD
\SI{4000}{yr} }\hspace{0pt}%DIFAUXCMD
ago,
that is, }\DIFdelend \DIFaddbegin \DIFadd{before or around \mbox{%DIFAUXCMD
\SI{3500}{yr} }\hspace{0pt}%DIFAUXCMD
ago.
Uncertainties in the proper motion measurements mean that we cannot tell
if the ejection began }\DIFaddend before the planetary nebula phase \DIFaddbegin \DIFadd{or not}\DIFaddend .
In contrast, the blue semi-axis (predominantly S and E)
was active with outflow velocities of \SI{50}{km.s^{-1}}
\DIFdelbegin \DIFdel{from \num{1200} to \mbox{%DIFAUXCMD
\SI{2700}{yr} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{between \num{1000} 1nd \mbox{%DIFAUXCMD
\SI{3000}{yr} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend ago,
...
\bibitem[\protect\citeauthoryear{{Ali}, {Sabin}, {Snaid}  \& {Basurah}}{{Ali}
  et~al.}{2012}]{Ali:2012a}
{Ali} A.,  {Sabin} L.,  {Snaid} S.,   {Basurah} H.~M.,  2012, \aap, 541, A98

\bibitem[\protect\citeauthoryear{{Balick}}{{Balick}}{1987}]{Balick:1987b}
{Balick} B.,  1987, \aj, 94, 671

\bibitem[\protect\citeauthoryear{{Balick} \& {Frank}}{{Balick} \&
  {Frank}}{2002}]{Balick:2002a}
{Balick} B.,  {Frank} A.,  2002, \araa, 40, 439

\bibitem[\protect\citeauthoryear{{Balick}, {Perinotto}, {Maccioni}, {Terzian}
  \& {Hajian}}{{Balick} et~al.}{1994}]{Balick:1994a}
{Balick} B.,  {Perinotto} M.,  {Maccioni} A.,  {Terzian} Y.,   {Hajian} A.,
  1994, \apj, 424, 800

\bibitem[\protect\citeauthoryear{{Barker}}{{Barker}}{1989}]{Barker:1989a}
{Barker} T.,  1989, \apj, 340, 921

\bibitem[\protect\citeauthoryear{{Bear} \& {Soker}}{{Bear} \&
  {Soker}}{2017}]{Bear:2017a}
{Bear} E.,  {Soker} N.,  2017, \apjl, 837, L10

\bibitem[\protect\citeauthoryear{{Becker}, {Gieseking}  \& {Solf}}{{Becker}
  et~al.}{1984}]{Becker:1984a}
{Becker} I.,  {Gieseking} F.,   {Solf} J.,  1984, Mitteilungen der
  Astronomischen Gesellschaft Hamburg, 62, 253

\bibitem[\protect\citeauthoryear{{Boffin} \& {Jones}}{{Boffin} \&
  {Jones}}{2019}]{Boffin:2019a}
{Boffin} H. M.~J.,  {Jones} D.,  2019, {The Importance of Binaries in the
  Formation and Evolution of Planetary Nebulae}.
Springer International Publishing, Switzerland

\bibitem[\protect\citeauthoryear{{Bohigas}, {Escalante}, {Rodr{\'{\i}}guez}  \&
  {Dufour}}{{Bohigas} et~al.}{2015}]{Bohigas:2015c}
...
\bibitem[\protect\citeauthoryear{{Chen}, {Frank}, {Blackman}, {Nordhaus}  \&
  {Carroll-Nellenback}}{{Chen} et~al.}{2017}]{Chen:2017b}
{Chen} Z.,  {Frank} A.,  {Blackman} E.~G.,  {Nordhaus} J.,
  {Carroll-Nellenback} J.,  2017, \mnras, 468, 4465

\bibitem[\protect\citeauthoryear{{Chen}, {Ivanova}  \&
  {Carroll-Nellenback}}{{Chen} et~al.}{2020}]{Chen:2020a}
{Chen} Z.,  {Ivanova} N.,   {Carroll-Nellenback} J.,  2020, \apj, 892, 110

\bibitem[\protect\citeauthoryear{{Chong}, {Kwok}, {Imai}, {Tafoya}  \&
  {Chibueze}}{{Chong} et~al.}{2012}]{Chong:2012a}
{Chong} S.~N.,  {Kwok} S.,  {Imai} H.,  {Tafoya} D.,   {Chibueze} J.,  2012,
  \apj, 760, 115

\bibitem[\protect\citeauthoryear{{Corradi}, {Steffen}, {Schönberner}  \&
  {Jacob}}{{Corradi} et~al.}{2007}]{Corradi:2007a}
{Corradi} R.~L.~M.,  {Steffen} M.,  {Schönberner} D.,   {Jacob} R.,  2007,
  \aap, 474, 529

\bibitem[\protect\citeauthoryear{{Curtis}}{{Curtis}}{1918}]{Curtis:1918a}
{Curtis} H.~D.,  1918, Publications of Lick Observatory, 13, 55

\bibitem[\protect\citeauthoryear{{Delgado-Inglada} \&
  {Rodr{\'{\i}}guez}}{{Delgado-Inglada} \&
  {Rodr{\'{\i}}guez}}{2014}]{Delgado-Inglada:2014a}
{Delgado-Inglada} G.,  {Rodr{\'{\i}}guez} M.,  2014, \apj, 784, 173

\bibitem[\protect\citeauthoryear{{Delgado Inglada}, {Rodr{\'{\i}}guez},
  {Mampaso}  \& {Viironen}}{{Delgado Inglada}
  et~al.}{2009}]{Delgado-Inglada:2009a}
{Delgado Inglada} G.,  {Rodr{\'{\i}}guez} M.,  {Mampaso} A.,   {Viironen} K.,
  2009, \apj, 694, 1335

\bibitem[\protect\citeauthoryear{{Delgado-Inglada}, {Morisset}  \&
  {Stasińska}}{{Delgado-Inglada} et~al.}{2014}]{Delgado-Inglada:2014b}
{Delgado-Inglada} G.,  {Morisset} C.,   {Stasińska} G.,  2014, \mnras, 440,
  536

\bibitem[\protect\citeauthoryear{{Di Criscienzo} et~al.,}{{Di Criscienzo}
  et~al.}{2016}]{Di-Criscienzo:2016a}
{Di Criscienzo} M.,  et~al., 2016, \mnras, 462, 395

\bibitem[\protect\citeauthoryear{{Duncan}}{{Duncan}}{1937}]{Duncan:1937a}
{Duncan} J.~C.,  1937, \apj, 86, 496

\bibitem[\protect\citeauthoryear{{Feibelman}}{{Feibelman}}{1971}]{Feibelman:1971a}
{Feibelman} W.~A.,  1971, \jrasc, 65, 251

\bibitem[\protect\citeauthoryear{{Fisher} \& {Welsch}}{{Fisher} \&
  {Welsch}}{2008}]{Fisher:2008a}
...
\bibitem[\protect\citeauthoryear{{Frank} \& {Mellema}}{{Frank} \&
  {Mellema}}{1994}]{Frank:1994b}
{Frank} A.,  {Mellema} G.,  1994, \aap, 289, 937

\bibitem[\protect\citeauthoryear{{Frew}, {Parker}  \& {Bojičić}}{{Frew}
  et~al.}{2016}]{Frew:2016a}
{Frew} D.~J.,  {Parker} Q.~A.,   {Bojičić} I.~S.,  2016, \mnras, 455, 1459

\bibitem[\protect\citeauthoryear{{Garc{\'{\i}}a-D{\'{\i}}az}, {López},
  {Steffen}  \& {Richer}}{{Garc{\'{\i}}a-D{\'{\i}}az}
  et~al.}{2012}]{Garcia-Diaz:2012a}
{Garc{\'{\i}}a-D{\'{\i}}az} M.~T.,  {López} J.~A.,  {Steffen} W.,   {Richer}
  M.~G.,  2012, \apj, 761, 172

\bibitem[\protect\citeauthoryear{{Garc{\'{\i}}a-Segura}, {López}, {Steffen},
  {Meaburn}  \& {Manchado}}{{Garc{\'{\i}}a-Segura}
  et~al.}{2006}]{Garcia-Segura:2006a}
{Garc{\'{\i}}a-Segura} G.,  {López} J.~A.,  {Steffen} W.,  {Meaburn} J.,
  {Manchado} A.,  2006, \apjl, 646, L61

\bibitem[\protect\citeauthoryear{{García-Segura}}{{García-Segura}}{1997}]{Garcia-Segura:1997a}
{García-Segura} G.,  1997, \apjl, 489, L189

\bibitem[\protect\citeauthoryear{{García-Segura} \& {López}}{{García-Segura}
  \& {López}}{2000}]{Garcia-Segura:2000a}
{García-Segura} G.,  {López} J.~A.,  2000, \apj, 544, 336

\bibitem[\protect\citeauthoryear{{García-Segura}, {Ricker}  \&
  {Taam}}{{García-Segura} et~al.}{2018}]{Garcia-Segura:2018a}
{García-Segura} G.,  {Ricker} P.~M.,   {Taam} R.~E.,  2018, \apj, 860, 19

\bibitem[\protect\citeauthoryear{{Glanz} \& {Perets}}{{Glanz} \&
  {Perets}}{2020}]{Glanz:2020a}
{Glanz} H.,  {Perets} H.~B.,  2020, arXiv e-prints, p. arXiv:2004.00020

\bibitem[\protect\citeauthoryear{{González-Santamaría}, {Manteiga},
  {Manchado}, {Ulla}  \& {Dafonte}}{{González-Santamaría}
  et~al.}{2019}]{Gonzalez-Santamaria:2019a}
{González-Santamaría} I.,  {Manteiga} M.,  {Manchado} A.,  {Ulla} A.,
  {Dafonte} C.,  2019, \aap, 630, A150

\bibitem[\protect\citeauthoryear{{Guerrero}, {Suzett Rechy-García}  \&
  {Ortiz}}{{Guerrero} et~al.}{2020}]{Guerrero:2020a}
{Guerrero} M.~A.,  {Suzett Rechy-García} J.,   {Ortiz} R.,  2020, \apj, 890,
  50

\bibitem[\protect\citeauthoryear{{Hajian}, {Terzian}  \& {Bignell}}{{Hajian}
  et~al.}{1995}]{Hajian:1995a}
{Hajian} A.~R.,  {Terzian} Y.,   {Bignell} C.,  1995, \aj, 109, 2600

\bibitem[\protect\citeauthoryear{{Henry}, {Stephenson}, {Miller Bertolami},
  {Kwitter}  \& {Balick}}{{Henry} et~al.}{2018}]{Henry:2018a}
{Henry} R.~B.~C.,  {Stephenson} B.~G.,  {Miller Bertolami} M.~M.,  {Kwitter}
  K.~B.,   {Balick} B.,  2018, \mnras, 473, 241

\bibitem[\protect\citeauthoryear{{Herald} \& {Bianchi}}{{Herald} \&
  {Bianchi}}{2011}]{Herald:2011a}
{Herald} J.~E.,  {Bianchi} L.,  2011, \mnras, 417, 2440

\bibitem[\protect\citeauthoryear{{Holtzman} et~al.,}{{Holtzman}
  et~al.}{1995}]{Holtzman:1995a}
{Holtzman} J.~A.,  et~al., 1995, \pasp, 107, 156

\bibitem[\protect\citeauthoryear{{Hsia}, {Chau}, {Zhang}  \& {Kwok}}{{Hsia}
  et~al.}{2014}]{Hsia:2014a}
{Hsia} C.-H.,  {Chau} W.,  {Zhang} Y.,   {Kwok} S.,  2014, \apj, 787, 25

\bibitem[\protect\citeauthoryear{{Icke}, {Preston}  \& {Balick}}{{Icke}
  et~al.}{1989}]{Icke:1989a}
{Icke} V.,  {Preston} H.~L.,   {Balick} B.,  1989, \aj, 97, 462

\bibitem[\protect\citeauthoryear{{Jacob}, {Schönberner}  \& {Steffen}}{{Jacob}
  et~al.}{2013}]{Jacob:2013a}
...
\bibitem[\protect\citeauthoryear{{Kahn}}{{Kahn}}{1954}]{Kahn:1954a}
{Kahn} F.~D.,  1954, \bain, 12, 187

\bibitem[\protect\citeauthoryear{{Kahn} \& {West}}{{Kahn} \&
  {West}}{1985}]{Kahn:1985a}
{Kahn} F.~D.,  {West} K.~A.,  1985, \mnras, 212, 837

\bibitem[\protect\citeauthoryear{{Karakas} \& {Lattanzio}}{{Karakas} \&
  {Lattanzio}}{2007}]{Karakas:2007a}
{Karakas} A.,  {Lattanzio} J.~C.,  2007, \pasa, 24, 103

\bibitem[\protect\citeauthoryear{{Kastner}, {Weintraub}, {Gatley}, {Merrill}
  \& {Probst}}{{Kastner} et~al.}{1996}]{Kastner:1996a}
{Kastner} J.~H.,  {Weintraub} D.~A.,  {Gatley} I.,  {Merrill} K.~M.,   {Probst}
  R.~G.,  1996, \apj, 462, 777

\bibitem[\protect\citeauthoryear{{Kim} \& {Taam}}{{Kim} \&
  {Taam}}{2012}]{Kim:2012c}
{Kim} H.,  {Taam} R.~E.,  2012, \apj, 759, 59

\bibitem[\protect\citeauthoryear{{Kingsburgh} \& {Barlow}}{{Kingsburgh} \&
  {Barlow}}{1994}]{Kingsburgh:1994a}
{Kingsburgh} R.~L.,  {Barlow} M.~J.,  1994, \mnras, 271, 257

\bibitem[\protect\citeauthoryear{{Krti{\v{c}}ka}, {Kubát}  \&
  {Krti{\v{c}}ková}}{{Krti{\v{c}}ka} et~al.}{2020}]{Krticka:2020a}
{Krti{\v{c}}ka} J.,  {Kubát} J.,   {Krti{\v{c}}ková} I.,  2020, \aap, 635,
  A173

\bibitem[\protect\citeauthoryear{{Kwitter} \& {Henry}}{{Kwitter} \&
  {Henry}}{1996}]{Kwitter:1996a}
{Kwitter} K.~B.,  {Henry} R.~B.~C.,  1996, \apj, 473, 304

\bibitem[\protect\citeauthoryear{{Kwitter} \& {Henry}}{{Kwitter} \&
  {Henry}}{1998}]{Kwitter:1998a}
{Kwitter} K.~B.,  {Henry} R.~B.~C.,  1998, \apj, 493, 247

\bibitem[\protect\citeauthoryear{{Kwok}, {Purton}  \& {Fitzgerald}}{{Kwok}
  et~al.}{1978}]{Kwok:1978a}
{Kwok} S.,  {Purton} C.~R.,   {Fitzgerald} P.~M.,  1978, \apjl, 219, L125

\bibitem[\protect\citeauthoryear{{Liu}, {Liu}, {Luo}  \& {Barlow}}{{Liu}
  et~al.}{2004}]{Liu:2004a}
{Liu} Y.,  {Liu} X.-W.,  {Luo} S.-G.,   {Barlow} M.~J.,  2004, \mnras, 353,
  1231

\bibitem[\protect\citeauthoryear{{L\'opez}}{{L\'opez}}{1997}]{Lopez:1997a}
{L\'opez} J.~A.,  1997, in {Habing} H.~J.,  {Lamers} H.~J.~G.~L.~M.,  eds,  IAU
  Symposium Vol. 180, Planetary Nebulae. p.~197

\bibitem[\protect\citeauthoryear{{L\'opez}, {Roth}  \& {Tapia}}{{L\'opez}
  et~al.}{1993}]{Lopez:1993a}
{L\'opez} J.~A.,  {Roth} M.,   {Tapia} M.,  1993, \aap, 267, 194

\bibitem[\protect\citeauthoryear{{L\'opez}, {Richer},
  {Garc{\'{\i}}a-D{\'{\i}}az}, {Clark}, {Meaburn}, {Riesgo}, {Steffen}  \&
  {Lloyd}}{{L\'opez} et~al.}{2012}]{Lopez:2012a}
{L\'opez} J.~A.,  {Richer} M.~G.,  {Garc{\'{\i}}a-D{\'{\i}}az} M.~T.,  {Clark}
  D.~M.,  {Meaburn} J.,  {Riesgo} H.,  {Steffen} W.,   {Lloyd} M.,  2012,
  \rmxaa, 48, 3

\bibitem[\protect\citeauthoryear{{Luridiana}, {Morisset}  \&
  {Shaw}}{{Luridiana} et~al.}{2015}]{Luridiana:2015a}
{Luridiana} V.,  {Morisset} C.,   {Shaw} R.~A.,  2015, \aap, 573, A42

\bibitem[\protect\citeauthoryear{{Maciel} \& {Koppen}}{{Maciel} \&
  {Koppen}}{1994}]{Maciel:1994b}
{Maciel} W.~J.,  {Koppen} J.,  1994, \aap, 282, 436

\bibitem[\protect\citeauthoryear{{Meaburn}, {López}, {Gutiérrez}, {Quiróz},
  {Murillo}, {Valdéz}  \& {Pedrayez}}{{Meaburn} et~al.}{2003}]{Meaburn:2003a}
{Meaburn} J.,  {López} J.~A.,  {Gutiérrez} L.,  {Quiróz} F.,  {Murillo}
  J.~M.,  {Valdéz} J.,   {Pedrayez} M.,  2003, \rmxaa, 39, 185

\bibitem[\protect\citeauthoryear{{Mellema}}{{Mellema}}{2004}]{Mellema:2004a}
{Mellema} G.,  2004, \aap, 416, 623

\bibitem[\protect\citeauthoryear{{Miller Bertolami}}{{Miller
  Bertolami}}{2016}]{Miller-Bertolami:2016a}
{Miller Bertolami} M.~M.,  2016, \aap, 588, A25

\bibitem[\protect\citeauthoryear{{Miller Bertolami}}{{Miller
  Bertolami}}{2019}]{Miller-Bertolami:2019a}
{Miller Bertolami} M.~M.,  2019, in {Kerschbaum} F.,  {Groenewegen} M.,
  {Olofsson} H.,  eds,  IAU Symposium Vol. 343, IAU Symposium. pp 36--46

\bibitem[\protect\citeauthoryear{{O'Dell}, {Henney}  \& {Sabbadin}}{{O'Dell}
  et~al.}{2009}]{ODell:2009c}
{O'Dell} C.~R.,  {Henney} W.~J.,   {Sabbadin} F.,  2009, \aj, 137, 3815

\bibitem[\protect\citeauthoryear{{O'Dell}, {Ferland}, {Henney}  \&
  {Peimbert}}{{O'Dell} et~al.}{2013}]{ODell:2013b}
{O'Dell} C.~R.,  {Ferland} G.~J.,  {Henney} W.~J.,   {Peimbert} M.,  2013, \aj,
  145, 92

\bibitem[\protect\citeauthoryear{O'Meara}{O'Meara}{2007}]{OMeara:2007a}
...
\bibitem[\protect\citeauthoryear{{Osterbrock}, {Miller}  \&
  {Weedman}}{{Osterbrock} et~al.}{1966}]{Osterbrock:1966a}
{Osterbrock} D.~E.,  {Miller} J.~S.,   {Weedman} D.~W.,  1966, \apj, 145, 697

\bibitem[\protect\citeauthoryear{{Peimbert}}{{Peimbert}}{1978}]{Peimbert:1978a}
{Peimbert} M.,  1978, in {Terzian} Y.,  ed.,  IAU Symposium Vol. 76, Planetary
  Nebulae. pp 215--223

\bibitem[\protect\citeauthoryear{{Pereyra}, {López}  \& {Richer}}{{Pereyra}
  et~al.}{2016}]{Pereyra:2016a}
{Pereyra} M.,  {López} J.~A.,   {Richer} M.~G.,  2016, \aj, 151, 53

\bibitem[\protect\citeauthoryear{{Perinotto}, {Schönberner}, {Steffen}  \&
  {Calonaci}}{{Perinotto} et~al.}{2004}]{Perinotto:2004a}
{Perinotto} M.,  {Schönberner} D.,  {Steffen} M.,   {Calonaci} C.,  2004,
  \aap, 414, 993

\bibitem[\protect\citeauthoryear{{Phillips}}{{Phillips}}{2003}]{Phillips:2003c}
{Phillips} J.~P.,  2003, \mnras, 344, 501

\bibitem[\protect\citeauthoryear{{Podobedova}, {Kelleher}  \&
  {Wiese}}{{Podobedova} et~al.}{2009}]{Podobedova:2009a}
{Podobedova} L.~I.,  {Kelleher} D.~E.,   {Wiese} W.~L.,  2009, Journal of
  Physical and Chemical Reference Data, 38, 171

\bibitem[\protect\citeauthoryear{{Pottasch}, {Bernard-Salas}  \&
  {Roellig}}{{Pottasch} et~al.}{2009}]{Pottasch:2009a}
{Pottasch} S.~R.,  {Bernard-Salas} J.,   {Roellig} T.~L.,  2009, \aap, 499, 249

\bibitem[\protect\citeauthoryear{{Quireza}, {Rocha-Pinto}  \&
  {Maciel}}{{Quireza} et~al.}{2007}]{Quireza:2007a}
{Quireza} C.,  {Rocha-Pinto} H.~J.,   {Maciel} W.~J.,  2007, \aap, 475, 217

\bibitem[\protect\citeauthoryear{{Rechy-García}, {Guerrero}, {Duarte Puertas},
  {Chu}, {Toalá}  \& {Mirand a}}{{Rechy-García}
  et~al.}{2020}]{Rechy-Garcia:2020a}
{Rechy-García} J.~S.,  {Guerrero} M.~A.,  {Duarte Puertas} S.,  {Chu} Y.~H.,
  {Toalá} J.~A.,   {Mirand a} L.~F.,  2020, \mnras, 492, 1957

\bibitem[\protect\citeauthoryear{{Richer}, {López}, {Pereyra}, {Riesgo},
  {García-Díaz}  \& {Báez}}{{Richer} et~al.}{2008}]{Richer:2008a}
{Richer} M.~G.,  {López} J.~A.,  {Pereyra} M.,  {Riesgo} H.,  {García-Díaz}
  M.~T.,   {Báez} S.-H.,  2008, \apj, 689, 203

\bibitem[\protect\citeauthoryear{{Richer}, {López},
  {Garc{\'{\i}}a-D{\'{\i}}az}, {Clark}, {Pereyra}  \&
  {D{\'{\i}}az-Méndez}}{{Richer} et~al.}{2010}]{Richer:2010a}
{Richer} M.~G.,  {López} J.~A.,  {Garc{\'{\i}}a-D{\'{\i}}az} M.~T.,  {Clark}
  D.~M.,  {Pereyra} M.,   {D{\'{\i}}az-Méndez} E.,  2010, \apj, 716, 857

\bibitem[\protect\citeauthoryear{{Rubin}, {Colgan}, {Haas}, {Lord}  \&
  {Simpson}}{{Rubin} et~al.}{1997}]{Rubin:1997a}
{Rubin} R.~H.,  {Colgan} S. W.~J.,  {Haas} M.~R.,  {Lord} S.~D.,   {Simpson}
  J.~P.,  1997, \apj, 479, 332

\bibitem[\protect\citeauthoryear{{Rubin} et~al.,}{{Rubin}
  et~al.}{2002}]{Rubin:2002a}
{Rubin} R.~H.,  et~al., 2002, \mnras, 334, 777

\bibitem[\protect\citeauthoryear{{Rubio}, {Vázquez}, {Ramos-Larios},
  {Guerrero}, {Olguín}, {Guillén}  \& {Mata}}{{Rubio}
  et~al.}{2015}]{Rubio:2015a}
{Rubio} G.,  {Vázquez} R.,  {Ramos-Larios} G.,  {Guerrero} M.~A.,  {Olguín}
  L.,  {Guillén} P.~F.,   {Mata} H.,  2015, \mnras, 446, 1931

\bibitem[\protect\citeauthoryear{{Sahai} \& {Trauger}}{{Sahai} \&
  {Trauger}}{1998}]{Sahai:1998a}
{Sahai} R.,  {Trauger} J.~T.,  1998, \aj, 116, 1357

\bibitem[\protect\citeauthoryear{{Sahai}, {Morris}, {Sánchez Contreras}  \&
  {Claussen}}{{Sahai} et~al.}{2007}]{Sahai:2007a}
{Sahai} R.,  {Morris} M.,  {Sánchez Contreras} C.,   {Claussen} M.,  2007,
  \aj, 134, 2200

\bibitem[\protect\citeauthoryear{{Sahai}, {Morris}  \& {Villar}}{{Sahai}
  et~al.}{2011}]{Sahai:2011a}
{Sahai} R.,  {Morris} M.~R.,   {Villar} G.~G.,  2011, \aj, 141, 134

\bibitem[\protect\citeauthoryear{{Schönberner} \& {Steffen}}{{Schönberner} \&
  {Steffen}}{2019}]{Schonberner:2019a}
{Schönberner} D.,  {Steffen} M.,  2019, \aap, 625, A137

\bibitem[\protect\citeauthoryear{{Schönberner}, {Jacob}  \&
  {Steffen}}{{Schönberner} et~al.}{2005}]{Schonberner:2005a}
{Schönberner} D.,  {Jacob} R.,   {Steffen} M.,  2005, \aap, 441, 573

\bibitem[\protect\citeauthoryear{{Schönberner}, {Jacob}, {Lehmann},
  {Hildebrandt}, {Steffen}, {Zwanzig}, {Sandin}  \& {Corradi}}{{Schönberner}
  et~al.}{2014}]{Schonberner:2014a}
{Schönberner} D.,  {Jacob} R.,  {Lehmann} H.,  {Hildebrandt} G.,  {Steffen}
  M.,  {Zwanzig} A.,  {Sandin} C.,   {Corradi} R.~L.~M.,  2014, Astronomische
  Nachrichten, 335, 378

\bibitem[\protect\citeauthoryear{{Schönberner}, {Balick}  \&
  {Jacob}}{{Schönberner} et~al.}{2018}]{Schonberner:2018a}
{Schönberner} D.,  {Balick} B.,   {Jacob} R.,  2018, \aap, 609, A126

\bibitem[\protect\citeauthoryear{{Soker}}{{Soker}}{1997}]{Soker:1997a}
{Soker} N.,  1997, \apjs, 112, 487

\bibitem[\protect\citeauthoryear{{Soker}}{{Soker}}{2004}]{Soker:2004b}
{Soker} N.,  2004, \mnras, 350, 1366

\bibitem[\protect\citeauthoryear{{Soker}}{{Soker}}{2016}]{Soker:2016b}
{Soker} N.,  2016, \mnras, 455, 1584

\bibitem[\protect\citeauthoryear{{Soker} \& {Hadar}}{{Soker} \&
  {Hadar}}{2002}]{Soker:2002b}
{Soker} N.,  {Hadar} R.,  2002, \mnras, 331, 731

\bibitem[\protect\citeauthoryear{{Soker} \& {Rappaport}}{{Soker} \&
  {Rappaport}}{2001}]{Soker:2001a}
{Soker} N.,  {Rappaport} S.,  2001, \apj, 557, 256

\bibitem[\protect\citeauthoryear{{Stanghellini} \& {Haywood}}{{Stanghellini} \&
  {Haywood}}{2018}]{Stanghellini:2018a}
{Stanghellini} L.,  {Haywood} M.,  2018, \apj, 862, 45

\bibitem[\protect\citeauthoryear{{Steffen}, {Koning}, {Esquivel},
  {García-Segura}, {García-Díaz}, {López}  \& {Magnor}}{{Steffen}
  et~al.}{2013}]{Steffen:2013a}
{Steffen} W.,  {Koning} N.,  {Esquivel} A.,  {García-Segura} G.,
  {García-Díaz} M.~T.,  {López} J.~A.,   {Magnor} M.,  2013, \mnras, 436,
  470

\bibitem[\protect\citeauthoryear{Struve}{Struve}{1827}]{Struve:1827a}
...
\bibitem[\protect\citeauthoryear{{Tayal} \& {Zatsarinny}}{{Tayal} \&
  {Zatsarinny}}{2010}]{Tayal:2010a}
{Tayal} S.~S.,  {Zatsarinny} O.,  2010, \apjs, 188, 32

\bibitem[\protect\citeauthoryear{{Toalá} \& {Arthur}}{{Toalá} \&
  {Arthur}}{2014}]{Toala:2014a}
{Toalá} J.~A.,  {Arthur} S.~J.,  2014, \mnras, 443, 3486

\bibitem[\protect\citeauthoryear{{Toonen}, {Hamers}  \& {Portegies
  Zwart}}{{Toonen} et~al.}{2016}]{Toonen:2016a}
{Toonen} S.,  {Hamers} A.,   {Portegies Zwart} S.,  2016, Computational
  Astrophysics and Cosmology, 3, 6

\bibitem[\protect\citeauthoryear{{Toonen}, {Portegies Zwart}, {Hamers}  \&
  {Band opadhyay}}{{Toonen} et~al.}{2020}]{Toonen:2020a}
{Toonen} S.,  {Portegies Zwart} S.,  {Hamers} A.,   {Band opadhyay} D.,  2020,
  arXiv e-prints, p. arXiv:2004.07848

\bibitem[\protect\citeauthoryear{{Ueta}, {Mito}, {Otsuka}, {Nakada}, {Conn}  \&
  {Ladjal}}{{Ueta} et~al.}{2019}]{Ueta:2019a}
{Ueta} T.,  {Mito} H.,  {Otsuka} M.,  {Nakada} Y.,  {Conn} B.~C.,   {Ladjal}
  D.,  2019, \aj, 158, 145

\bibitem[\protect\citeauthoryear{{Ventura} \& {D'Antona}}{{Ventura} \&
  {D'Antona}}{2005}]{Ventura:2005a}
{Ventura} P.,  {D'Antona} F.,  2005, \aap, 431, 279

\bibitem[\protect\citeauthoryear{{Villaver}, {Manchado}  \&
  {Garc{\'{\i}}a-Segura}}{{Villaver} et~al.}{2002}]{Villaver:2002a}
{Villaver} E.,  {Manchado} A.,   {Garc{\'{\i}}a-Segura} G.,  2002, \apj, 581,
  1204

\bibitem[\protect\citeauthoryear{{Weedman}}{{Weedman}}{1968}]{Weedman:1968a}
{Weedman} D.~W.,  1968, \apj, 153, 49

\bibitem[\protect\citeauthoryear{{Weidmann} et~al.,}{{Weidmann}
  et~al.}{2020}]{Weidmann:2020a}
{Weidmann} W.~A.,  et~al., 2020, arXiv e-prints, p. arXiv:2005.10368

\bibitem[\protect\citeauthoryear{{Welsch}, {Fisher}, {Abbett}  \&
  {Regnier}}{{Welsch} et~al.}{2004}]{Welsch:2004a}
{Welsch} B.~T.,  {Fisher} G.~H.,  {Abbett} W.~P.,   {Regnier} S.,  2004,
  \mn@doi [\apj] {10.1086/421767}, \href
  {https://ui.adsabs.harvard.edu/abs/2004ApJ...610.1148W} {610, 1148}
...
\begin{figure}
  ...
  \caption{
    ...
    \DIFaddbeginFL \DIFaddFL{The dashed line indicates equality of the two estimates.
  }\DIFaddendFL }
